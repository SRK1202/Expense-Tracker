...
const Register = () => {
  ...
  useEffect(() => {
    // Remove sidebar padding for register page
    document.body.classList.add('register-auth');
    return () => {
      document.body.classList.remove('register-auth');
    };
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Registration failed: " + (error.message || "Unknown error"), toastOptions);
      setLoading(false);
    }
  };
  ...
  return (
    ...
    <div className="register-page" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <Container className="mt-5 d-flex justify-content-center" style={{position: 'relative', zIndex: "2 !important", color:"white !important"}}>
